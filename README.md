What is Dashtag Solo?
---------------------

**Dashtag Solo** is a rails application which uses the **[Dashtag Engine](https://github.com/anirudh-eka/dashtag)** that can be configured and deployed onto heroku very rapidly.

The **Dashtag Engine** pulls tweets and instagram post based on hashtag(s) and/or username(s) and displays them using [masonry](http://masonry.desandro.com/). 
...
Check out an example of Dashtag [here](http://haikuhitmen.com/).
...
-------------------
 ...
 [![Deploy](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/boetter/dashtag_solo.git)
